...
var _segfaultvicta$awoo$Awoo$renderLobbyPlayer = function (player) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id(
				A2(_elm_lang$core$Basics_ops['++'], 'player-', player.uuid)),
			_1: {ctor: '[]'}
		},
		player.leader ? {
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], player.name, ' (Leader)')),
			_1: {ctor: '[]'}
		} : {
			ctor: '::',
...
var _segfaultvicta$awoo$Awoo$renderLobbyList = function (players) {
	return {
		ctor: '::',
		_0: A2(
			...
			A2(_elm_lang$core$List$map, _segfaultvicta$awoo$Awoo$renderLobbyPlayer, players)),
		_1: {ctor: '[]'}
	};
};
var _segfaultvicta$awoo$Awoo$renderTallyVote = function (vote) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('tally-vote'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _segfaultvicta$awoo$Awoo$renderTallyItem = function (tally) {
	var tallyCountString = _elm_lang$core$Basics$toString(
		_elm_lang$core$List$length(tally.votes));
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('tallyitem'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'  (',
						A2(_elm_lang$core$Basics_ops['++'], tallyCountString, ')')))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('tally-votes'),
						_1: {ctor: '[]'}
					},
					A2(_elm_lang$core$List$map, _segfaultvicta$awoo$Awoo$renderTallyVote, tally.votes)),
				_1: {ctor: '[]'}
			}
		});
};
var _segfaultvicta$awoo$Awoo$votesInTallyItem = function (tally) {
	return _elm_lang$core$List$length(tally.votes);
};
var _segfaultvicta$awoo$Awoo$renderTally = function (tally) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$ul,
...
var _segfaultvicta$awoo$Awoo$renderGhostView = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('tally-list'),
			_1: {ctor: '[]'}
		},
		_segfaultvicta$awoo$Awoo$renderTally(model.tally));
};
var _segfaultvicta$awoo$Awoo$serverDialogBody = function (message) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row server-msg'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _segfaultvicta$awoo$Awoo$targetedDialogBody = function (lastTarget) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row last-targeted-name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], lastTarget.name, ' was marked for death!')),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					lastTarget.alive ? {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('row but-they-lived'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('...but they survived!'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					} : {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('row and-they-died'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'They died, and in death the truth was revealed: They were a ',
										A2(_elm_lang$core$Basics_ops['++'], lastTarget.role, '!'))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _segfaultvicta$awoo$Awoo$roleDialogBody = function (role) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('row role-name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('row role-description'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(role.description),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('row role-image'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
								...
								_elm_lang$html$Html$img,
								{
									...
									_0: _elm_lang$html$Html_Attributes$src(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'assets/',
											A2(_elm_lang$core$Basics_ops['++'], role.name, '.jpg'))),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('img-fluid role-image'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _segfaultvicta$awoo$Awoo$serverDialogHeaderError = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mr-auto p-2 error-dialog-header'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('modal-header-text'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('A lamentable error!'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _segfaultvicta$awoo$Awoo$serverDialogHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('A sudden revelation!'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _segfaultvicta$awoo$Awoo$targetedDialogHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mr-auto p-2'),
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Meanwhile...'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _segfaultvicta$awoo$Awoo$voteDialogHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mr-auto p-2'),
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Take Action On...'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _segfaultvicta$awoo$Awoo$roleDialogHeader = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('mr-auto p-2'),
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Your Role Is...'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _segfaultvicta$awoo$Awoo$gamestateDecoder = _elm_lang$core$Json_Decode$string;
var _segfaultvicta$awoo$Awoo$emitGameState = function (state) {
	var _p0 = state;
	switch (_p0.ctor) {
		case 'Day':
			return 'day';
		case 'Night':
			return 'night';
		default:
			return 'how did i get here i am not good at computer';
	}
};
var _segfaultvicta$awoo$Awoo$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
														...
														return function (o) {
															return function (p) {
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return {name: a, socketUrl: b, gameState: c, phase: d, debugMsg: e, isLeader: f, role: g, playerlist: h, rulesetName: i, rolesetList: j, roleDialog: k, voteDialog: l, targetedDialog: m, serverDialog: n, error: o, lastTargeted: p, votedUUID: q, serverMessage: r, tally: s};
																		};
																	};
																};
															};
...
var _segfaultvicta$awoo$Awoo$Player = F3(
	function (a, b, c) {
		return {name: a, uuid: b, leader: c};
	});
var _segfaultvicta$awoo$Awoo$playerDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_segfaultvicta$awoo$Awoo$Player,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'uuid', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'leader', _elm_lang$core$Json_Decode$bool));
var _segfaultvicta$awoo$Awoo$playerlistDecoder = _elm_lang$core$Json_Decode$list(_segfaultvicta$awoo$Awoo$playerDecoder);
var _segfaultvicta$awoo$Awoo$Role = F5(
	function (a, b, c, d, e) {
		return {name: a, description: b, alive: c, team: d, night_action: e};
	});
var _segfaultvicta$awoo$Awoo$roleDecoder = A6(
...
var _segfaultvicta$awoo$Awoo$Flags = function (a) {
	return {socketUrl: a};
};
var _segfaultvicta$awoo$Awoo$MessageDecoderContainer = F2(
	function (a, b) {
		return {message: a, payload: b};
	});
var _segfaultvicta$awoo$Awoo$messageDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (message, payload) {
			return A2(_segfaultvicta$awoo$Awoo$MessageDecoderContainer, message, payload);
		}),
	A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'payload', _elm_lang$core$Json_Decode$value));
var _segfaultvicta$awoo$Awoo$PleasewaitDecoderContainer = function (a) {
	return {isLeader: a};
};
var _segfaultvicta$awoo$Awoo$pleasewaitDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	function (payload) {
		return _segfaultvicta$awoo$Awoo$PleasewaitDecoderContainer(payload);
	},
	A2(_elm_lang$core$Json_Decode$field, 'leader', _elm_lang$core$Json_Decode$bool));
var _segfaultvicta$awoo$Awoo$TargetedDecoderContainer = F3(
	function (a, b, c) {
		return {name: a, role: b, alive: c};
	});
var _segfaultvicta$awoo$Awoo$targetedDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_segfaultvicta$awoo$Awoo$TargetedDecoderContainer,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'role', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'alive', _elm_lang$core$Json_Decode$bool));
var _segfaultvicta$awoo$Awoo$TallyItem = F2(
	function (a, b) {
		return {name: a, votes: b};
	});
var _segfaultvicta$awoo$Awoo$tallyDecoder = _elm_lang$core$Json_Decode$list(
	A3(
		_elm_lang$core$Json_Decode$map2,
		_segfaultvicta$awoo$Awoo$TallyItem,
		A2(
			_elm_lang$core$Json_Decode$at,
			{
				ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$list(
			A6(
				...
				A2(_elm_lang$core$Json_Decode$field, 'team', _elm_lang$core$Json_Decode$int),
				A2(_elm_lang$core$Json_Decode$field, 'night_action', _elm_lang$core$Json_Decode$int)))));
var _segfaultvicta$awoo$Awoo$partialRolesetListDecoder = _elm_lang$core$Json_Decode$keyValuePairs(_segfaultvicta$awoo$Awoo$rolesetDecoder);
...
var _segfaultvicta$awoo$Awoo$Night = {ctor: 'Night'};
var _segfaultvicta$awoo$Awoo$Day = {ctor: 'Day'};
var _segfaultvicta$awoo$Awoo$Lobby = {ctor: 'Lobby'};
var _segfaultvicta$awoo$Awoo$NameEntry = {ctor: 'NameEntry'};
var _segfaultvicta$awoo$Awoo$GameCannotBeJoined = {ctor: 'GameCannotBeJoined'};
var _segfaultvicta$awoo$Awoo$update = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Recv':
				var _p30 = _p1._0;
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeString, _segfaultvicta$awoo$Awoo$messageDecoder, _p30);
				if (_p2.ctor === 'Ok') {
					var _p28 = _p2._0;
					var _p3 = _p28.message;
					switch (_p3) {
						case 'awoo':
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{gameState: _segfaultvicta$awoo$Awoo$NameEntry}),
								{ctor: '[]'});
						case 'cannotjoin':
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								...
								{ctor: '[]'});
						case 'pleasewait':
							var _p4 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$pleasewaitDecoder, _p28.payload);
							if (_p4.ctor === 'Ok') {
								return _p4._0.isLeader ? A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{isLeader: true, gameState: _segfaultvicta$awoo$Awoo$Lobby}),
									{
										ctor: '::',
										_0: A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{isLeader: false, gameState: _segfaultvicta$awoo$Awoo$Lobby}),
									{
										ctor: '::',
										_0: A2(
											_elm_lang$websocket$WebSocket$send,
								...
								var _p5 = A2(
									...
									{ctor: '_Tuple2', _0: _p4._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'rolesetlist':
							var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$partialRolesetListDecoder, _p28.payload);
							if (_p6.ctor === 'Ok') {
								var roles = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, _p6._0);
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
								...
								var _p7 = A2(
									_elm_lang$core$Debug$log,
									'rolesetlist payload error: ',
									{ctor: '_Tuple2', _0: _p6._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{
						...
						case 'roleset':
							var _p8 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$rolesetDecoder, _p28.payload);
							if (_p8.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{rulesetName: _p8._0.name}),
									{ctor: '[]'});
							} else {
								var _p9 = A2(
									_elm_lang$core$Debug$log,
									'roleset payload error: ',
									{ctor: '_Tuple2', _0: _p8._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'playerlist':
							var _p10 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$playerlistDecoder, _p28.payload);
							if (_p10.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
								...
								var _p11 = A2(
									...
									{ctor: '_Tuple2', _0: _p10._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'role':
							var _p12 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$roleDecoder, _p28.payload);
							if (_p12.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
								...
								var _p13 = A2(
									_elm_lang$core$Debug$log,
									'role payload error',
									{ctor: '_Tuple2', _0: _p12._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'phase':
							var _p14 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$int, _p28.payload);
							if (_p14.ctor === 'Ok') {
								var _p15 = _p14._0;
								var state = _elm_lang$core$Native_Utils.eq(
									A2(_elm_lang$core$Basics_ops['%'], _p15, 2),
								...
								return (!_elm_lang$core$Native_Utils.eq(model.gameState, _segfaultvicta$awoo$Awoo$Dead)) ? A2(
									...
									_elm_lang$core$Native_Utils.update(
										model,
										{gameState: state, phase: _p15, voteDialog: false, roleDialog: false, targetedDialog: false}),
									{
										ctor: '::',
										_0: A2(
											_elm_lang$websocket$WebSocket$send,
								...
								var _p16 = A2(
									...
									{ctor: '_Tuple2', _0: _p14._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'tally':
							var _p17 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$tallyDecoder, _p28.payload);
							if (_p17.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
								...
								var _p18 = A2(
									_elm_lang$core$Debug$log,
									'tally payload error',
									{ctor: '_Tuple2', _0: _p17._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'targeted':
							var _p19 = A2(_elm_lang$core$Json_Decode$decodeValue, _segfaultvicta$awoo$Awoo$targetedDecoder, _p28.payload);
							if (_p19.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{targetedDialog: true, lastTargeted: _p19._0}),
									{ctor: '[]'});
							} else {
								var _p20 = A2(
									_elm_lang$core$Debug$log,
									'targeted payload error',
									{ctor: '_Tuple2', _0: _p19._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'dead':
							return A2(
								...
								{ctor: '[]'});
						case 'privatemessage':
							var _p21 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, _p28.payload);
							if (_p21.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{serverDialog: true, serverMessage: _p21._0}),
									{ctor: '[]'});
							} else {
								var _p22 = A2(
									_elm_lang$core$Debug$log,
									'error payload error',
									{ctor: '_Tuple2', _0: _p21._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'error':
							var _p23 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, _p28.payload);
							if (_p23.ctor === 'Ok') {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
										{serverDialog: true, error: true, serverMessage: _p23._0}),
									{ctor: '[]'});
							} else {
								var _p24 = A2(
									_elm_lang$core$Debug$log,
									'private message payload error',
									{ctor: '_Tuple2', _0: _p23._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						case 'victory':
							var _p25 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$int, _p28.payload);
							if (_p25.ctor === 'Ok') {
								var victorystate = _elm_lang$core$Native_Utils.eq(_p25._0, 1) ? _segfaultvicta$awoo$Awoo$FinalEvil : _segfaultvicta$awoo$Awoo$FinalGood;
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
								...
								var _p26 = A2(
									...
									{ctor: '_Tuple2', _0: _p25._0, _1: _p28.payload});
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									model,
									{ctor: '[]'});
						...
						default:
							var _p27 = A2(_elm_lang$core$Debug$log, 'unknown command from server', _p30);
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
					...
					var _p29 = A2(
						_elm_lang$core$Debug$log,
						'recv payload error: ',
						{ctor: '_Tuple2', _0: _p2._0, _1: _p30});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
			...
			case 'OpenRoleDialog':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{roleDialog: true}),
					{ctor: '[]'});
			case 'AckNonServerDialogs':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{roleDialog: false, voteDialog: false, targetedDialog: false, votedUUID: ''}),
					{ctor: '[]'});
			case 'AckServerDialog':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{serverDialog: false, error: false, serverMessage: ''}),
					{ctor: '[]'});
			case 'OpenVoteDialog':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'VoteAction':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{voteDialog: false, votedUUID: _p31}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$websocket$WebSocket$send,
								...
								_elm_lang$core$Json_Encode$object(
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'voteFor',
											_1: _elm_lang$core$Json_Encode$string(_p31)
										},
										_1: {
											ctor: '::',
											_0: {
												...
												_1: _elm_lang$core$Json_Encode$string(
													_segfaultvicta$awoo$Awoo$emitGameState(model.gameState))
											},
											_1: {ctor: '[]'}
										}
									}))),
...
var _segfaultvicta$awoo$Awoo$Indeterminate = {ctor: 'Indeterminate'};
var _segfaultvicta$awoo$Awoo$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			name: '',
			socketUrl: flags.socketUrl,
			gameState: _segfaultvicta$awoo$Awoo$Indeterminate,
			phase: 0,
			debugMsg: '',
			isLeader: false,
			...
			serverDialog: false,
			error: false,
			lastTargeted: A3(_segfaultvicta$awoo$Awoo$TargetedDecoderContainer, '', '', false),
			votedUUID: '',
			serverMessage: '',
			tally: {ctor: '[]'}
		},
...
var _segfaultvicta$awoo$Awoo$ResetGame = {ctor: 'ResetGame'};
var _segfaultvicta$awoo$Awoo$renderLeader = function (model) {
	return model.isLeader ? A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('leader-display'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('btn btn-warn reset-game'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$ResetGame),
									_1: {ctor: '[]'}
								}
							}
						},
...
var _segfaultvicta$awoo$Awoo$renderRoleset = function (roleset) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_segfaultvicta$awoo$Awoo$SetRules(roleset.name)),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					roleset.name,
					A2(_elm_lang$core$Basics_ops['++'], ' - ', roleset.description))),
			_1: {ctor: '[]'}
		});
};
var _segfaultvicta$awoo$Awoo$renderRolesetList = function (rolesetList) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$ul,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('rolesets'),
				_1: {ctor: '[]'}
			},
			A2(_elm_lang$core$List$map, _segfaultvicta$awoo$Awoo$renderRoleset, rolesetList)),
		_1: {ctor: '[]'}
	};
};
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: (model.isLeader && _elm_lang$core$Native_Utils.eq(model.rulesetName, '')) ? A2(
						...
						_segfaultvicta$awoo$Awoo$renderRolesetList(model.rolesetList)) : A2(
						_elm_lang$html$Html$span,
						{ctor: '[]'},
						{
							ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _segfaultvicta$awoo$Awoo$renderLeader(model),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _segfaultvicta$awoo$Awoo$VoteAction = function (a) {
	return {ctor: 'VoteAction', _0: a};
};
var _segfaultvicta$awoo$Awoo$renderVoteOption = function (player) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('vote-list-option'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_segfaultvicta$awoo$Awoo$VoteAction(player.uuid)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _segfaultvicta$awoo$Awoo$voteDialogBody = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('vote-list-select'),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, _segfaultvicta$awoo$Awoo$renderVoteOption, model.playerlist)),
			_1: {ctor: '[]'}
		});
};
var _segfaultvicta$awoo$Awoo$OpenVoteDialog = {ctor: 'OpenVoteDialog'};
var _segfaultvicta$awoo$Awoo$AckServerDialog = {ctor: 'AckServerDialog'};
var _segfaultvicta$awoo$Awoo$AckNonServerDialogs = {ctor: 'AckNonServerDialogs'};
var _segfaultvicta$awoo$Awoo$dialog = function (model) {
	return _krisajenkins$elm_dialog$Dialog$view(
		(model.roleDialog || (model.voteDialog || model.targetedDialog)) ? _elm_lang$core$Maybe$Just(
			{
				...
				header: _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$html$Html$div,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$AckNonServerDialogs),
								_1: {ctor: '[]'}
							}
						},
						model.roleDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$roleDialogHeader,
							_1: {
								ctor: '::',
								_0: A2(
							...
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$voteDialogHeader,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$i,
						...
						} : (model.targetedDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$targetedDialogHeader,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$i,
							...
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$serverDialogHeader,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$i,
				...
				body: _elm_lang$core$Maybe$Just(
					A2(
						...
						model.roleDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$roleDialogBody(model.role),
							_1: {ctor: '[]'}
						} : (model.voteDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$voteDialogBody(model),
							_1: {ctor: '[]'}
						} : (model.targetedDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$targetedDialogBody(model.lastTargeted),
							_1: {ctor: '[]'}
						} : (model.serverDialog ? {
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$serverDialogBody(model.serverMessage),
							_1: {ctor: '[]'}
						} : {
							ctor: '::',
							_0: _elm_lang$html$Html$text(''),
			...
			}) : (model.serverDialog ? _elm_lang$core$Maybe$Just(
			{
				closeMessage: _elm_lang$core$Maybe$Nothing,
				containerClass: _elm_lang$core$Maybe$Just('modal-container'),
				header: _elm_lang$core$Maybe$Just(
					model.error ? A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('d-flex fill error-dialog-header'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$AckServerDialog),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _segfaultvicta$awoo$Awoo$serverDialogHeaderError,
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$i,
...
var _segfaultvicta$awoo$Awoo$OpenRoleDialog = {ctor: 'OpenRoleDialog'};
var _segfaultvicta$awoo$Awoo$renderGame = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('interactions'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('btn btn-info show-role'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$OpenRoleDialog),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Show Role'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('btn btn-info show-vote'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$OpenVoteDialog),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Take Action'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _segfaultvicta$awoo$Awoo$EnterName = {ctor: 'EnterName'};
var _segfaultvicta$awoo$Awoo$UpdateName = function (a) {
	return {ctor: 'UpdateName', _0: a};
};
var _segfaultvicta$awoo$Awoo$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('awoo-interface container'),
			_1: {ctor: '[]'}
		},
		function () {
			var _p32 = model.gameState;
			switch (_p32.ctor) {
				case 'Indeterminate':
					return {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('awoo-indeterminate row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('howling at the moon...'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					};
				case 'GameCannotBeJoined':
					return {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('awoo-cannot-be-joined row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('game cannot presently be joined :('),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					};
				case 'NameEntry':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('awoo-name-entry-dialog row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('OwO who\'s this?'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('awoo-name-entry-input row d-flex justify-content-center'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_segfaultvicta$awoo$Awoo$UpdateName),
													_1: {ctor: '[]'}
												}
											}
										},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('awoo-name-entry-button row d-flex justify-content-center'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_segfaultvicta$awoo$Awoo$EnterName),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('fas fa-3x fa-check-circle'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
				...
				case 'Lobby':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('lobby row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									ctor: '::',
									_0: _segfaultvicta$awoo$Awoo$renderLobby(model),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _segfaultvicta$awoo$Awoo$dialog(model),
									_1: {ctor: '[]'}
								})),
						_1: {ctor: '[]'}
					};
				case 'Day':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('daytime row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									ctor: '::',
									_0: _segfaultvicta$awoo$Awoo$renderGame(model),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				case 'Night':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('nighttime row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							A2(
								_elm_lang$core$Basics_ops['++'],
				...
				case 'Dead':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('dead row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('notification'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('regrettably, you have died. whether you are a werewolf\'s snack, or fell prey to the machinations of paranoid villagers, surely someday you will have your revenge.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('spooky-ghost-vision'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _segfaultvicta$awoo$Awoo$renderGhostView(model),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
				...
				case 'FinalGood':
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('finale-good row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('the game is over, and the \"good\" guys won! the villagers are safe... for now.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
				...
				default:
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('finale-evil row d-flex justify-content-center'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('the game is over, and the werewolves won! the villagers are lunch... for now.'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
...
var _segfaultvicta$awoo$Awoo$Recv = function (a) {
	return {ctor: 'Recv', _0: a};
};
var _segfaultvicta$awoo$Awoo$subs = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, model.socketUrl, _segfaultvicta$awoo$Awoo$Recv);
};
var _segfaultvicta$awoo$Awoo$main = _elm_lang$html$Html$programWithFlags(
	{init: _segfaultvicta$awoo$Awoo$init, view: _segfaultvicta$awoo$Awoo$view, subscriptions: _segfaultvicta$awoo$Awoo$subs, update: _segfaultvicta$awoo$Awoo$update})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (socketUrl) {
...
if (typeof _segfaultvicta$awoo$Awoo$main !== 'undefined') {
    _segfaultvicta$awoo$Awoo$main(Elm['Awoo'], 'Awoo', undefined);
}
